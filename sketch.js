...
function setup() {
  ...
  stand2 = new Division(70, 680, 10, 200);
  stand3 = new Division(140, 680, 10, 200);
  stand4 = new Division(210, 680, 10, 200);
  stand5 = new Division(280, 680, 10, 200);
  stand6 = new Division(350, 680, 10, 200);
  stand7 = new Division(420, 680, 10, 200);
  stand8 = new Division(487,680,5,200);
